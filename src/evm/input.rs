...
impl EVMInputTy {
    pub fn from_str(s: &str) -> Option<Self> {
        match s {
            "ABI" => Some(EVMInputTy::ABI),
            "Borrow" => Some(EVMInputTy::Borrow),
            "ArbitraryCallBoundedAddr" => Some(EVMInputTy::ArbitraryCallBoundedAddr),
            "Liquidate" => Some(EVMInputTy::Liquidate),
            _ => None,
        }
    }
}
